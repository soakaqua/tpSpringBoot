...
<body>
	...
	<div class="container">
		...
		<a href="${ctx}/auth/personne/addFormateur" class="btn btn-link">ajout
			formateur </a> <a href="${ctx}/auth/personne/addEleve"
			class="btn btn-link">ajout Eleve </a>
		...
		<table class="table">
			...
			<c:forEach items="${personne}" var="p">
				<tr>
					...
					<td><a href="${ctx}/auth/personne/edit?id=${p.id}"
						class="btn btn-info">editer</a></td>
					<!-- cacher supprimer si non admin -->
					<sec:authorize access="hasAnyRole('ROLE_ADMIN')">
						<td><a href="${ctx}/auth/personne/delete?id=${p.id}"
